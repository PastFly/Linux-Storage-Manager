...
/// partition geometry and exact LV growth are representable here; every other
/// current frozen action remains rejected until its contract is added separately.
...
mod tests {
    ...
    #[test]
    fn native_lv_spec_preserves_exact_growth_values() {
